...
Before starting the lecture, please run 

```{r}
renv::init()
```

Doing this will automatically install the packages needed for the workshop into the project library. By doing this, you will be able to work within the project using the exact same R packages that were used to create the workshop. 
...
$flipper\_length\_mm = f(bill\_length\_mm) + f(body\_mass\_g) + f(island) + \epsilon$
